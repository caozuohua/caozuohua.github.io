...
- [x] 把《100w 稳健型基金组合 · 执行手册》整理为系列中的实战篇。
- [x] 写一篇系列开篇，解释为什么稳健理财适合工程化。
- [x] 补齐风险认知、资产配置、基金筛选三篇基础文章。
- [x] 设计一个固定复盘模板：目标、配置、偏离、动作、备注。
- [x] 增加 Agent 辅助复盘文章，把再平衡阈值显式化。
- [x] 明确所有工具文章的边界：辅助分析，不自动下单，不给确定性预测。
